...
### Configuration
Under the fields, **Configuration** holds what belongs to the way of timing chosen. For sound cues that is the **count-in**, the seconds the page waits before the lamp goes on: three is the least, because it counts three in, and a longer one simply waits before counting them — make it as long as you need to get a hand to the switch. **Stop between exposures** is described in the next section. On a wide screen Configuration stands open, in a rail beside the map.

<p align="center"><img src="figures/web-configuration.png" width="300" align="top" alt="Configuration open: the count-in and Stop between exposures"> <img src="figures/web-totals.png" width="300" align="top" alt="Totals chosen: the totals column is the one in ink, and a run gives each patch its whole exposure"></p>
